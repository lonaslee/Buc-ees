...
public class Movenda {
     ...
     */
    public Movenda(Supplier<double[]> velsSupplier, DoubleSupplier angleSupplier) {
    ...
    public void update() {
        ...
        System.out.println("Pose[ current=" + currentPose + ", target=" + targetPose + " ]");
        if (tm != null) {
